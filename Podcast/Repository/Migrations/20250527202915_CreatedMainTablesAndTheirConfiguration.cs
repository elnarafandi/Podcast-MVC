...
{
    /// <inheritdoc />
    public partial class CreatedMainTablesAndTheirConfiguration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Podcasts_TeamMembers_TeamMemberId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserPodcasts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppUserPodcasts_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppUserPodcasts_Podcasts_PodcastId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppUserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    PodcastId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PodcastId1 = table.Column<int>(type: "int", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EpisodeGuests", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlaylistEpisodes", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUserPodcasts_AppUserId",
                table: "AppUserPodcasts",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_AppUserPodcasts_PodcastId",
                table: "AppUserPodcasts",
                column: "PodcastId");
